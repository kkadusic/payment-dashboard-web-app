							...
							>
								...
								>
									<Menu.Item key="transakcije24">
										<Link to="/transakcije24">
											Last 24h
										</Link>
									</Menu.Item>
									<Menu.Item key="transakcijeMjesec">
										<Link to="/transakcijeMjesec">
											{" "}
											Last month
										</Link>
									</Menu.Item>
									<Menu.Item key="transakcijeMerchant">
										<Link to="/transakcijeMerchant">
											Spent by merchant
										</Link>
									</Menu.Item>
									<Menu.Item key="transakcijeProizvod">
										<Link to="/transakcijeProizvod">
											{" "}
											Spent by product
										</Link>
									</Menu.Item>
								...
								>
									<Menu.Item key="dodaniRacuni">
										<Link to="/dodaniRacuni">
											{" "}
											View added accounts
										</Link>
									</Menu.Item>
									<Menu.Item key="dodavanjeRacuna">
										<Link to="/dodavanjeRacuna">
											{" "}
											Add new account
										</Link>
									</Menu.Item>
									<Menu.Item key="brisanjeRacuna">
										<Link to="/brisanjeRacuna">
											{" "}
											Delete account
										</Link>
									</Menu.Item>
